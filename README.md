<h1><img src="client/src/assets/icon.png" alt="ChitChat Logo" width="30" style="vertical-align:middle; margin-right:10px;" />  <strong>ChitChat — Real-Time Messaging Web App</strong></h1>
